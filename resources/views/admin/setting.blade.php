                ...
                <div class="mt-5 md:mt-0 md:col-span-5">
                    ...
                    <div class="shadow sm:rounded-md sm:overflow-hidden">
                        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                            <div class="grid grid-cols-3 gap-6">
                                ...
                                <div class="mt-1 flex rounded-md shadow-sm">
                                    <input type="text" name="name" id="name" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-sm rounded-r-md sm:text-sm border-gray-300" placeholder="website name" value="{{ $config->name }}">
                                </div>
                                </div>
                            </div>
                            <div class="grid grid-cols-3 gap-6">
                                ...
                                <div class="mt-1 flex rounded-md shadow-sm">
                                    <input type="text" name="address" id="address" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-sm rounded-r-md sm:text-sm border-gray-300" placeholder="company address" value="{{ $config->address }}">
                                </div>
                                </div>
                            </div>
                            <div class="grid grid-cols-3 gap-6">
                                ...
                                <div class="mt-1 flex rounded-md shadow-sm">
                                    <input type="email" name="email" id="email" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-sm rounded-r-md sm:text-sm border-gray-300" placeholder="company email" value="{{ $config->email }}">
                                </div>
                                </div>
                            </div>
                            <div class="grid grid-cols-3 gap-6">
                                ...
                                <div class="mt-1 flex rounded-md shadow-sm">
                                    <input type="tel" name="phone" id="phone" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-sm rounded-r-md sm:text-sm border-gray-300" placeholder="company phone" value="{{ $config->phone }}">
                                </div>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                            <textarea id="about" name="about" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="About">{{ $config->about }}</textarea>
                            </div>
                                ...
                                <div class="mt-4 space-y-4">
                                    <div class="flex items-start">
                                        <div class="flex items-center h-5">
                                            <input id="register" name="register" type="checkbox" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded" @if($config->register)
                                            checked
                                            @endif>
                                        </div>
