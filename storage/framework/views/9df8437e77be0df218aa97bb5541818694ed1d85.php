...
<div class="flex justify-center mb-5 mt-5">
    <div class="w-8/12 bg-white p-6 rounded-lg">
        <div class="flex item-center sm:items-stretch">
            <a href="<?php echo e(route('dashboard')); ?>" class="px-2 rounded-md text-md font-medium hover:text-blue-700 hover:bg-gray-100">Dashboard</a>
            <a href="<?php echo e(route('services.admin')); ?>" class="px-2 rounded-md text-md font-medium hover:text-blue-700 hover:bg-gray-100">Services</a>
            <a href="<?php echo e(route('inbox')); ?>" class="px-2 rounded-md text-md font-medium hover:text-blue-700 hover:bg-gray-100">Inbox</a>
            <a href="<?php echo e(route('setting')); ?>" class="px-2 rounded-md text-md font-medium hover:text-blue-700 hover:bg-gray-100">Setting</a>
        </div>
    </div>
</div>
...
<?php /**PATH C:\Users\tarek wagih\Documents\GitHub\posty\resources\views/layouts/admin.blade.php ENDPATH**/ ?>